...
using _160._Intersection_of_Two_Linked_Lists;

var listA = new ListNode(4);
listA.next = new ListNode(1);
var node = new ListNode(8);
node.next = new ListNode(4);
node.next.next = new ListNode(5);
listA.next.next = node;

var listB = new ListNode(5);
listB.next = new ListNode(6);
listB.next.next = new ListNode(1);
listB.next.next.next = node;

var res = Helper.GetIntersectionNode(listA, listB);

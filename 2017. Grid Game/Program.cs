...
At the start of the game, the first robot moves from (0, 0) to (1, n-1), collecting all 
    the points from the cells on its path. For all cells (r, c) traversed on the path, grid[r][c] is set to 0.
...
using _2017._Grid_Game;

var grid = new int[][] { [20, 3, 20, 17, 2, 12, 15, 17, 4, 15], [20, 10, 13, 14, 15, 5, 2, 3, 14, 3] };
var r = Helper.GridGame(grid);
